...
namespace FilmReview.Controllers
{
    public class DirectorsController : Controller
    {
        ...
        {
            var directors = db.Directors.Include(d => d.Film);
        ...
        public ActionResult Create([Bind(Include = "DirectorID,DirectorFirstName,DirectorLastName,FilmId")] Director director)
        {
